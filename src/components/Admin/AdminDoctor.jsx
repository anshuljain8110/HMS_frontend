...
function AdminDoctor() {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://hms-backend-toag.onrender.com/doctor/get-doctors"
        );
  ...
  const handleAddDoctor = async (e) => {
    e.preventDefault();
    await axios.post("https://hms-backend-toag.onrender.com/doctor/add-doctor",{
        name:docname,
  ...
  const editPatient = async (id) => {
    await axios
      .put(`https://hms-backend-toag.onrender.com/doctor/update-doctor/${id}`, {})
      .then((res) => {
        Swal.fire({
          title: "Success",
          icon: "success",
  ...
  const deletePatient = async (id) => {
    await axios
      .delete(`https://hms-backend-toag.onrender.com/doctor/delete-doctor/${id}`,)
      .then((res) => {
        Swal.fire({
          title: "Success",
          icon: "success",
